...
interface SegmentedControlProps<T extends string> {
   ...
   * as `segmented-<name>`, with each choice under it
   * (`segmented-<name>-<value>`) — CLAUDE.md "Test selectors".
   */
  name?: string;
  className?: string;
}
...
export function SegmentedControl<T extends string>({
  ...
  return (
    <div
      ...
      role="group"
      aria-label={label}
      data-test-selector={testSelectorFor("segmented", name)}
      className={cn(
      ...
      {options.map((option) => {
        ...
        return (
          <button
            ...
            data-test-selector={testSelectorFor(testSelectorFor("segmented", name), option.value)}
