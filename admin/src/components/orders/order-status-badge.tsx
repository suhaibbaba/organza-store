...
// amber = in motion, green = done as far as the shop is concerned, red =
// money that didn't happen, grey = reversed.
const STATUS_BADGE_STYLES: Record<OrderStatus, string> = {
  NEW: "bg-primary/10 text-primary",
  PREPARING: "bg-amber-500/10 text-amber-600 dark:text-amber-400",
  HANDED_TO_COURIER: "bg-emerald-500/10 text-emerald-700 dark:text-emerald-400",
