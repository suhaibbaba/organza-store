...
// Editing product details/price/stock is Admin + Manager only (CLAUDE.md
// rule 5) — Employees never reach this screen.
const EDIT_ALLOWED_ROLES = ROLES.filter((role) => role !== "EMPLOYEE");
...
export default function EditProductPage() {
  ...
  return (
    <RoleGuard allow={EDIT_ALLOWED_ROLES}>
