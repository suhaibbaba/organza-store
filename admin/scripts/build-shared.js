...
// "@shared" (admin/node_modules/@shared -> ../shared/dist). Written as a
...
//
// Mirrors backend/scripts/build-shared.js — keep the two in sync.
"use strict";
...
const sharedDir = path.resolve(adminDir, "..", "shared");
const sharedDist = path.join(sharedDir, "dist");
const nodeModulesDir = path.join(adminDir, "node_modules");
