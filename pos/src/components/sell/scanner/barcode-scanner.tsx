...
// Told apart so the cashier gets an instruction rather than a shrug: a refused
...
// of the text as well as off `name`, or a refusal is reported as "no camera on
// this device" and the one person who could fix it is told not to bother.
