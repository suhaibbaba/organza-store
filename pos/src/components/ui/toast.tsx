...
//
// Rendered into <body> through a portal because the scanner is a Radix sheet
// portalled to the body, and a toast has to come out on top of the camera it
// is reporting on. Going straight to <body> also keeps these pinned to the
// viewport whatever the selling screen's own layout does above them.
