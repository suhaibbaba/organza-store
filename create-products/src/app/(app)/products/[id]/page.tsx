      ...
      <div className="sticky top-0 z-20 bg-slate-50/90 backdrop-blur border-b border-slate-100 px-4 md:px-6 h-14 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <span
              className={`text-[10px] font-bold px-2 py-0.5 rounded-full flex-shrink-0 ${statusColor(product.status)}`}
            >
              {product.status}
            </span>
          </div>
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 text-brand-600 text-xs font-semibold rounded-xl hover:bg-indigo-100 transition-colors flex-shrink-0"
        >
